...
export default function ImageGrid() {
  ...
  if (!images.length) {
    return (
      <div className="flex-1 flex items-center justify-center text-base flex-col gap-2" style={{ color: 'var(--color-muted)' }}>
          ...
          return (
            ...
            >
              ...
              <div className="absolute top-1.5 right-1.5 z-10 flex gap-1">
                {isEdited && (
                  <div className="text-white text-[11px] font-mono font-bold px-1.5 py-0.5 rounded uppercase tracking-wider"
              ...
              {img.processed && (
                <div className="absolute bottom-8 right-1.5 z-10 bg-green-500 text-white text-[11px] font-mono px-1.5 py-0.5 rounded" aria-label="Processed">
                  ✓
                </div>
              )}
              ...
              />
              <div className="p-2">
                <div className="text-[13.5px] font-medium truncate" style={{ color: 'var(--color-text)' }} title={img.name}>
                  {img.name}
                </div>
                ...
                {img.altText && (
                  <div className="font-mono text-[11px] truncate mt-0.5" style={{ color: 'var(--color-muted)' }} title={img.altText}>
                    ALT: {img.altText}
                  </div>
                )}
              </div>
