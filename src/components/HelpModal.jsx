      ...
      >
        ...
        >
          ...
          <div className="px-5 py-4 flex items-center justify-between flex-shrink-0" style={{ borderBottom: '1px solid var(--color-border)' }}>
            ...
            <button onClick={onClose} className="btn btn-ghost text-[14px]" aria-label="Close help">✕ Close</button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-3">
            ...
            <div className="text-center pt-3 pb-2">
              <div className="text-[13px] font-mono" style={{ color: 'var(--color-border2)' }}>
              ...
              <a
                ...
                className="text-[13px] font-mono hover:underline"
