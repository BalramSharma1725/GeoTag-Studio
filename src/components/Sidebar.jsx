    ...
    <>
      ...
      >
        ...
        <div className="px-5 py-4" style={{ borderBottom: '1px solid var(--color-border)' }}>
          ...
          <span className="text-[13px] font-mono uppercase tracking-widest" style={{ color: 'var(--color-border2)' }}>
            GPS Metadata Editor
          </span>
        </div>
        ...
        <nav className="p-2 flex-1" role="tablist" aria-label="Application views">
          {NAV.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-[15.5px] font-medium mb-0.5 border transition-all duration-150 ${
                view === item.id
          ...
          {images.length > 0 && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-[15.5px] font-medium mb-0.5 border border-transparent text-muted hover:bg-surface2 hover:text-text transition-all duration-150"
        ...
        {/* Stats */}
        <div className="px-4 py-3 font-mono text-[13px] space-y-1" style={{ borderTop: '1px solid var(--color-border)', color: 'var(--color-border2)' }}>
          {[
